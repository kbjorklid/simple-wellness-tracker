...
function Calendar({
    ...
    return (
        <DayPicker
            ...
            components={{
                IconLeft: ({ ...props }) => <span className="material-symbols-outlined text-[18px]">chevron_left</span>,
                IconRight: ({ ...props }) => <span className="material-symbols-outlined text-[18px]">chevron_right</span>,
            }}
            {...props}
        />
    );
